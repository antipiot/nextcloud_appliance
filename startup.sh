...
docker run -d --name=nextcloud --restart unless-stopped -p $https:443 --name=nextcloud --link $dbhostname -e TZ=Europe/Geneva -v $rootdatafolderc/config:/config -v $rootdatafolder/data:/data linuxserver/nextcloud
